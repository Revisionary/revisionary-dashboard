<template>
  <aside>
    ...
    <nuxt-link to="/" v-bind:class="{'active':(this.$route.name === 'index')}"><DashboardIcon /> Dashboard</nuxt-link>
    <a href="#"><NotificationIcon /> Notifications</a>
    <a href="#"><TasksIcon /> Tasks (24)</a>
